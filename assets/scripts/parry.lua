...
--- Resets the window/cooldown timers to 0.
...
-- @return boolean true if a parry window is currently open
...
-- @param incoming ds.Vec3 incoming projectile velocity
-- @param speed_boost optional multiplier applied to the flipped velocity (default 1.5)
-- @return ds.Vec3 reflected velocity
