...
public:
    ...
    void bindVertexUniform(uint32_t slot, RHIBuffer buffer,
                           uint64_t offset, uint64_t size) override;
    void bindFragmentUniform(uint32_t slot, RHIBuffer buffer,
                             uint64_t offset, uint64_t size) override;
    ...
    void uploadBuffer(RHIBuffer dst, const void* data,
                      uint64_t size, uint64_t dstOffset) override;
    void uploadTexture(RHITexture dst, const void* data, uint64_t size,
                       uint32_t mipLevel, uint32_t layer) override;
    void copyBuffer(RHIBuffer dst, uint64_t dstOffset,
                    RHIBuffer src, uint64_t srcOffset, uint64_t size) override;
...
public:
    ...
    void uploadImmediate(RHIBuffer dst, const void* data,
                         uint64_t size, uint64_t dstOffset) override;
    void uploadImmediateTexture(RHITexture dst, const void* data,
