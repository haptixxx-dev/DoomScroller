...
public:
    ...
    // -----------------------------------------------------------------------
    virtual void uploadImmediate(RHIBuffer dst, const void* data,
                                 uint64_t size, uint64_t dstOffset = 0) = 0;
    virtual void uploadImmediateTexture(RHITexture dst, const void* data,
                                        uint64_t size, uint32_t mipLevel = 0) = 0;
